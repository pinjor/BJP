      ...
      child: Column(
        children: [
          TextFormField(
            ...
            decoration:
                InputDecoration(hintText: 'এখানে লিখুন', labelText: 'নাম'),
          ...
          TextFormField(
            controller: _firstNameTEController,
            decoration:
                InputDecoration(hintText: 'এখানে লিখুন', labelText: 'ইমেইল'),
            autovalidateMode: AutovalidateMode.onUserInteraction,
            validator: (String? value) {
              if (value?.trim().isEmpty ?? true) {
                return 'Enter valid Name';
          ...
          TextFormField(
            controller: _firstNameTEController,
            decoration: InputDecoration(
                hintText: 'এখানে লিখুন', labelText: 'পাসওয়ার্ড'),
            autovalidateMode: AutovalidateMode.onUserInteraction,
            validator: (String? value) {
              if (value?.trim().isEmpty ?? true) {
                return 'Enter valid Name';
          ...
          TextFormField(
            controller: _firstNameTEController,
            decoration: InputDecoration(
                hintText: 'এখানে লিখুন', labelText: 'জন্ম তারিখ'),
            autovalidateMode: AutovalidateMode.onUserInteraction,
            validator: (String? value) {
              if (value?.trim().isEmpty ?? true) {
                return 'Enter valid Name';
